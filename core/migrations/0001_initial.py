# Generated by Django 4.2.8 on 2024-04-11 08:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('work', 'В работе'), ('accept', 'Принят в работу'), ('transit', 'В пути'), ('received', 'Получен')], default='work', max_length=256, verbose_name='Статус')),
